...
//  学籍信息
    ...
    public String showStudentInfo(Model model,Integer id){
        if (id == null){
            return "redirect:/admin/showStudent";
        }

        model.addAttribute("studentInfo",studentInfoService.findById(id));

        return "admin/showStudentInfo";
    }

//    学籍修改页面
    @RequestMapping(value = "/editStudentInfo", method = {RequestMethod.GET})
    public String studentInfo(Model model,int id) throws Exception {
...
//    学籍修改提交处理
    ...
    public String studentInfoEdit(StudentInfoCustom studentInfoCustom) throws Exception {
        studentInfoService.updateById(studentInfoCustom);
