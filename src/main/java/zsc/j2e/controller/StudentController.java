...
import zsc.j2e.service.CourseService;
import zsc.j2e.service.SelectedCourseService;
...
public class StudentController {
    ...
    public String showStudentInfo(Model model){
        Subject subject = SecurityUtils.getSubject();
        StudentInfoCustom  studentInfoCustom = studentInfoService.findById(Integer.parseInt((String) subject.getPrincipal()));

        model.addAttribute("studentInfo",studentInfoCustom);
